...
(emulator), on a calculator the harness had just reset. It is the error attached to [Inter](Inter.md), as [serrSlope](serrSlope.md) is to the slope.
...
[Inter](Inter.md) · [serrSlope](serrSlope.md) · [serrLine](serrLine.md)
