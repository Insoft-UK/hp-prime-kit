...
(emulator), on a calculator the harness had just reset. It is [SSerr](SSerr.md) divided by [DFerr](DFerr.md), and [Fval](Fval.md) is [MS](MS.md) divided by this.
...
[MS](MS.md) · [SSerr](SSerr.md) · [Fval](Fval.md)
