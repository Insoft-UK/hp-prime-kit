...
(emulator), on a calculator the harness had just reset. It reads as a number rather than as a truth, and with [n₁](n₁.md) and [n₂](n₂.md) both 50 the choice changes the answer least.
...
[Method](Method.md) · [s₁](s₁.md) · [DF](DF.md)
