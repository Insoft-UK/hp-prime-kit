...
(emulator), on a calculator the harness had just reset. It is an input to a prediction rather than an output of a test, and [Yval](Yval.md) is what the app would compute from it.
...
[Yval](Yval.md) · [Xlist](Xlist.md) · [Inter](Inter.md)
