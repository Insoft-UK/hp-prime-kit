...
(emulator), on a calculator the harness had just reset. It is what the app computes from [Xval](Xval.md), and both read 0 with no line fitted.
...
[Xval](Xval.md) · [Ylist](Ylist.md) · [serrLine](serrLine.md)
