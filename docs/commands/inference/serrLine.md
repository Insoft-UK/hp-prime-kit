...
(emulator), on a calculator the harness had just reset. It is the line’s own error, where [serrInter](serrInter.md) and [serrSlope](serrSlope.md) are its two coefficients’.
...
[serrInter](serrInter.md) · [serrSlope](serrSlope.md) · [coefDet](coefDet.md)
