...
one of nine Finance variables that behave this way -- [NbPmt](NbPmt.md), [IPYR](IPYR.md), [PV](PV.md), [PMT](PMT.md), [FV](FV.md), [PPYR](PPYR.md), [CPYR](CPYR.md), [BEG](BEG.md) and `GSize`, the
