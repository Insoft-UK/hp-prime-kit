...
one of nine Finance variables that behave this way -- [NbPmt](NbPmt.md), `IPYR`, [PV](PV.md), [PMT](PMT.md), [FV](FV.md), [PPYR](PPYR.md), [CPYR](CPYR.md), [BEG](BEG.md) and [GSize](GSize.md), the
...
[TvmIPYR](TvmIPYR.md) was measured in Phase 7 from a batch nobody had touched, so
...
[TvmIPYR](TvmIPYR.md) · [PV](PV.md) · [PPYR](PPYR.md) · [apps.finance-shows-two-decimals](../../topics/apps.md#apps.finance-shows-two-decimals)
