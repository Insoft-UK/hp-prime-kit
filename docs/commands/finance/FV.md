...
one of nine Finance variables that behave this way -- [NbPmt](NbPmt.md), [IPYR](IPYR.md), [PV](PV.md), [PMT](PMT.md), `FV`, [PPYR](PPYR.md), [CPYR](CPYR.md), [BEG](BEG.md) and [GSize](GSize.md), the
...
[TvmFV](TvmFV.md) was measured in Phase 7 from a batch nobody had touched, so
...
[TvmFV](TvmFV.md) · [PV](PV.md) · [PPYR](PPYR.md) · [apps.finance-shows-two-decimals](../../topics/apps.md#apps.finance-shows-two-decimals)
