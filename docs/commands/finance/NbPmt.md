...
one of nine Finance variables that behave this way -- `NbPmt`, [IPYR](IPYR.md), [PV](PV.md), [PMT](PMT.md), [FV](FV.md), [PPYR](PPYR.md), [CPYR](CPYR.md), [BEG](BEG.md) and [GSize](GSize.md), the
...
[TvmNbPmt](TvmNbPmt.md) · [PV](PV.md) · [PPYR](PPYR.md) · [apps.finance-shows-two-decimals](../../topics/apps.md#apps.finance-shows-two-decimals)
