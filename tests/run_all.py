...
SUITES = [
    ...
    ('test_emulator.py', 'the emulator: installing, and reading back'),
    ...
    ('test_reference.py', 'the documentation: its format, and what it made'),
    ('test_examples_run.py', 'running the examples on the emulator, without it'),
]
